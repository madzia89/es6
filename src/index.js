...
//
//
// //SPREAD OPERATOR - tworzy nowe obiekty na podstawie starych obiektów
//
// const obj = {
//     name: 'Magda',
//     lastname: 'xxx'
// }
// //kopia tego obiektu
// const obj2 = Object.assign({}, obj) //shallowa copy of obj
// const obj3 = JSON.stringify(obj) // zamienia obiekt na string  a JSON.parse na początku tego wyrażenia zamieniłoby tego stringa z powrotem na obiekt
//
// const obj4 = { //KOPIA pierwszego obj!!!!!!
//     ...obj
// }
//
// const obj5 ={
//     ...obj,
//     lastname: "Magdewicz"
// } // tworzy kopię obiektu ale zmienia lastname na "magdewicz"

//REST OPERATOR
//poniższa funkcja ma wylogowac wszystkie arhumenty jakie dostanie
const logAll = function (){
    console.log(arguments)
}

logAll(1,2,3, 'mala', 2, "ksasjhd")

const logAllArrow = (...args) =>console.log(args)
logAllArrow(1,2,3, 'mala', 2, "ksasjhd")

const add = (a,b, ...rest) => {
    console.log('rest of the unused parameters if more are given', rest)
    return a + b
}
